				...
				<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
					...
					<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
						...
						<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link active" href="/admin/settings">
                                 <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                    <span class="svg-icon svg-icon-2">
                                       <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<div class="card-body border-top p-9">
											...
											<div class="row mb-20">
                                             ...
                                             <span class="d-inline-block position-relative">
                                                <!--begin::Label-->
                                                <span class="fs-3 fw-bold m-0 mb-1">Support</span>
												 <!--end::Label-->
												 <!--begin::Line-->
                                                <span class="d-inline-block position-absolute h-4px bottom-0 end-0 start-0 bg-primary translate rounded"></span>
												 <!--end::Line-->
                                             </span>
													<div class="text-gray-600 mt-5">Сообщение, которое будет отправляться в саппорт новым пользователям после регистрации </div>
												</div>
												<!--begin::Label-->
												<!--end::Label-->
												<!--begin::Col-->
												<div class="input-group mb-5 mt-5">
													<%
														Object message = request.getAttribute("support_default_message");
														out.println("<input type=\"text\" class=\"form-control\" placeholder=\"Enter default message\" value=\"" + (message == null ? "" : message) + "\" id=\"settings_support_message\" aria-describedby=\"basic-addon3\">");
													%>
													<div class="d-flex justify-content-end" style="margin-left: 50px">
														<div class="form-check form-check-solid form-check-custom form-switch">
															<%
																out.println("<input id=\"settings_support_checked\" class=\"form-check-input w-45px h-30px\" style=\"cursor:pointer\" type=\"checkbox\" " + ((boolean) request.getAttribute("support_default_enabled") ? " checked=\"\"" : "") + ">");
															%>
												...
												<!--end::Col-->
												<div class="d-flex mt-5 justify-content-end"><span id="saveSettings" class="btn btn-primary">Save changes</span></div>
											</div>
										</div>
									</form>
								</div>
...
<script>
	$("#saveSettings").on('click', () => {
		var settings_support_message = $("#settings_support_message").val();
		var settings_support_checked = $("#settings_support_checked");

		if (settings_support_checked.is(":checked") && settings_support_message == "") {
			noti("Укажите сообщение", "error");
			return;
		}
		...
		$.ajax({
			...
			data: {
				...
				message: settings_support_message,
				enabled: settings_support_checked.is(":checked")
			},
			success: function(response) {
				if(response == "1") {
					noti("Настройки успешно изменены", "success");
				} else if(response == "2") {
					noti("Сообщение слишком длинное, максимальная длина - 512 символов", "error");
				} else {
