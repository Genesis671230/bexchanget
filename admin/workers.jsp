<%@ page import="ru.tiedie.cryptoexchange.utils.StringUtil" %>
...
<head>
	...
	<title>Workers | Admin Panel</title>
	<meta charset="utf-8">
	...
	<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
		...
		<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
			...
			<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
				...
				<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
					...
					<a href="/panel">
						...
						<span class="app-sidebar-logo-default" style="font-size: 22px; color: white; font-weight: bold; margin-bottom: 0; margin-left: 5px;">Admin Panel</span>
					</a>
					<!--end::Logo image-->
				...
				<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
					...
					<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
						...
						<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link" href="/admin/deposits">
                                 <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                    <span class="svg-icon svg-icon-2">
                                       <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link active" href="/admin/workers">
                                 <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                    <span class="svg-icon svg-icon-2">
                                       <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link" href="/admin/mnemonics">
                                 <span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
												<span class="svg-icon svg-icon-2">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<span class="menu-title">Mnemonics</span>
								</a>
								<!--end:Menu link-->
							</div>
							<div class="menu-item">
			...
			<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
				...
				<div class="d-flex flex-column flex-column-fluid">
					...
					<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
						...
						<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
							...
							<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
								<!--begin::Title-->
								<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Workers</h1>
								<!--end::Title-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-muted">Workers</li>
									<!--end::Item-->
								</ul>
								<!--end::Breadcrumb-->
							</div>
					...
					<div id="kt_app_content" class="app-content flex-column-fluid">
						...
						<div id="kt_app_content_container" class="app-container container-fluid">
								<!--begin::Aside column-->
								<div class="d-flex flex-column gap-7 gap-lg-10 w-100 mb-7 me-lg-10" style="width: 100%">
									<!--begin::Start block-->
									<div class="card card-flush py-4">
										...
										<div class="card-body pt-0">
											...
											<div class="mb-10 fv-row fv-plugins-icon-container">
												...
												<!--end::Input-->
												<!--begin::Description-->
												<div class="text-muted fs-7">Для добавления воркера, укажите его почту</div>
												<!--end::Description-->
													...
													<div class="table-responsive">
														<table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_ecommerce_report_customer_orders_table">
															...
															<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
																<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Customer Name: activate to sort column descending" style="width: 50px;" aria-sort="ascending">ID</th>
																<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending" style="width: 150px;">Email</th>
																<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending" style="width: 100px;">Username</th>
																<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending" style="width: 100px;">Password</th>
																<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 50px;">Users</th>
																<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 50px;">Deposits</th>
																<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 50px;">Registered</th>
																<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 150px;">Domains</th>
																<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 50px;">Action</th></tr>
															<!--end::Table row-->
															</thead>
															<!--end::Table head-->
															<!--begin::Table body-->
															...
															<%
																...
																for (Map<String, Object> worker : workers) {
																	Object workerId = worker.get("worker_id");
																	Object email = worker.get("email");
																	Object username = worker.get("username");
																	Object password = worker.get("password");
																	Object users = worker.get("users");
																	Object deposits = worker.get("deposits");
																	Object regDate = worker.get("reg_date");
																	Object domains = worker.get("domains");
																	out.println("<tr>\n" +
																			"   <td class=\"min-w-70px text-dark fs-6\">" + workerId + "</td>\n" +
																			"   <td class=\"min-w-70px text-dark fs-6\">" + email + "</td>\n" +
																			"   <td class=\"min-w-70px text-dark fs-6\">" + username + "</td>\n" +
																			"   <td class=\"min-w-70px text-dark fs-6\">" + password + "</td>\n" +
																			"   <td class=\"min-w-70px text-dark fs-6\">" + users + "</td>\n" +
																			"   <td class=\"min-w-70px text-dark fs-6\">" + deposits + "</td>\n" +
																			"   <td class=\"min-w-70px text-dark fs-6\">" + regDate + "</td>\n" +
																			"   <td class=\"min-w-70px text-dark fs-6\">" + domains + "</td>\n" +
																			"   <td>\n" +
																			"      <a data-bs-toggle=\"modal\" data-bs-target=\"#view_addresses\" onclick=\"viewWorkerAddresses(" + workerId + ")\" class=\"btn btn-xs btn-success edit-worker\" data-original-title=\"Edit worker\">Edit</a>" +
																			"      <a data-bs-toggle=\"modal\" data-bs-target=\"#delete_worker\" onclick=\"deleteWorker(" + workerId + ")\" class=\"btn btn-xs btn-danger delete-worker\" data-original-title=\"Delete worker\">Delete</a>\n" +
																			"   </td>\n" +
																			"</tr>");
																}
															%>
				...
				<div class="modal fade" id="view_addresses" tabindex="-1" aria-hidden="true">
					<!--begin::Modal dialog-->
					<div class="modal-dialog modal-dialog-centered mw-650px">
						...
						<div class="modal-content rounded">
							...
							<div class="modal-header pb-0 border-0 justify-content-end">
								<!--begin::Close-->
								<div id="view_mnemonics_close" class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
							...
							<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
								<div class="mb-13 text-center">
									<!--begin::Title-->
									<h1 class="mb-3">Edit worker addresses</h1>
									<!--end::Title-->
								</div>
								<div id="view_addresses_data">
									<div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
										<!--begin::Label-->
										<label class="d-flex align-items-center fs-6 fw-semibold mb-2">
											<span class="required">BTC</span>
										</label>
										<!--end::Label-->
										<input id="btc_address" class="form-control form-control-solid" placeholder="bc1..." name="target_title">
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
									<div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
										<!--begin::Label-->
										<label class="d-flex align-items-center fs-6 fw-semibold mb-2">
											<span class="required">ETH</span>
										</label>
										<!--end::Label-->
										<input id="eth_address" class="form-control form-control-solid" placeholder="0x19..." name="target_title">
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
									<div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
										<!--begin::Label-->
										<label class="d-flex align-items-center fs-6 fw-semibold mb-2">
											<span class="required">LTC</span>
										</label>
										<!--end::Label-->
										<input id="ltc_address" class="form-control form-control-solid" placeholder="ltc2..." name="target_title">
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
								</div>
								<!--begin:Form-->
							...
							<input type="hidden" id="worker_edit_id" value="0">
				...
				<div id="kt_app_footer" class="app-footer">
					...
					<div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
						...
						<div class="text-dark order-2 order-md-1">
							...
							<%
								out.println("<a href=\"#\" target=\"_blank\" class=\"text-gray-800 text-hover-primary\">" + request.getAttribute("domain") + " Admin Panel</a>");
							%>
						</div>
						<!--end::Copyright-->
					</div>
...
<script>
	$('#index_update_bind').on('click', function(e) {
		e.preventDefault();
		var email = $("#index_inputEmailLogin").val();
		...
		if(email == "") {
			...
			$.ajax({
				...
				success: function(response) {
					if(response == "1") {
						noti("Воркер был успешно добавлен, перезагрузите страницу", "success");
					} else if(response == "2") {
						noti("Некорректная почта", "error");
					} else if(response == "3") {
						noti("Пользователя не существует.", "error");
					} else if(response == "4") {
						noti("Пользователь уже является воркером", "error");
					} else {
	...
	function deleteWorker(workerId) {
		$.ajax({
			...
			success: function(response) {
				if(response == "1") {
					noti("Воркер был успешно удален, перезагрузите страницу", "success");
				} else if(response == "2") {
					noti("Пользователя не существует.", "error");
				} else if(response == "3") {
					noti("Пользователь не является воркером", "error");
				} else {
					noti("Произошла ошибка, обратитесь к администратору", "error")
				}
			}
	...
	function viewWorkerAddresses(workerId) {
		document.getElementById('worker_edit_id').value = workerId;

		$.ajax({
			url: "../api/admin",
			type: "POST",
			data: {
				action: "GET_WORKER_ADDRESSES",
				worker_id: workerId
			},
			success: function(response) {
				if(response == "2") {
					...
					console.log(json['LTC'])
					document.getElementById('btc_address').value = json['BTC'];
					document.getElementById('eth_address').value = json['ETH'];
					document.getElementById('ltc_address').value = json['LTC'];
				}
			}
		})
	}
