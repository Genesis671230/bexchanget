...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <%
        out.println("<title>Cookies Policy | " + request.getAttribute("domain_exchange_name") + "</title>");
    %>
  <%
...
<ul>
	<%
        out.println("<li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to " + request.getAttribute("domain_exchange_name") + ".</li>");
	%>
	<li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
	<%
        out.println("<li><strong>Website</strong> refers to " + request.getAttribute("domain_exchange_name") + "</li>");
	%>
