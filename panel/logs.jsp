...
<head>
	...
	<title>Logs | Partner Panel</title>
	<meta charset="utf-8">
				...
				<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
					...
					<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
						...
						<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link active" href="/panel/logs">
                                 <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                    <span class="svg-icon svg-icon-2">
                                       <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<table class="table table-hover align-middle table-row-dashed fs-6 gy-5" id="kt_table_customers_logs">
											...
											<%
												...
												for (Map<String, Object> log : logs) {
													long userId = (long) log.get("user_id");
													...
													String logHtml = String.format("<tr>\n" +
															"   <td><a href=\"/panel/user-edit?id=%s\" class=\"text-dark fw-bold text-hover-primary mb-1 fs-6\">%s</a></td>\n" +
															"   <td>%s</td>\n" +
															"   <td class=\"pe-0 min-w-200px\">%s</td>\n" +
															"   <td class=\"min-w-70px text-dark fs-6\">\n" +
															"      <div class=\"badge badge-secondary addtobadgestat\">%s</div>\n" +
															"   </td>\n" +
															"</tr>", userId, email, action, date, ip);
													out.println(logHtml);
												}
											%>
											</tbody>
