...
<head>
	...
	<title>Support | Partner Panel</title>
	<meta charset="utf-8">
...
<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
	...
	<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
		...
		<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
				...
				<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
					...
					<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
						...
						<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link active" href="/panel/support">
                                 <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                    <span class="svg-icon svg-icon-2">
                                       <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
												...
												<div class="card" id="kt_chat_messenger">
													...
													<div class="card-body" id="kt_chat_messenger_body">
                                                      ...
                                                      margin-top: 25%;">
																<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-rocket-takeoff mb-2" viewbox="0 0 16 16">
													...
													<div class="card-footer pt-4" id="kt_chat_messenger_footer">
														...
														<div class="d-flex flex-stack">
															...
															<div class="d-flex align-items-center me-2">
																<form id="send_image_form" style="display: none;" action="../api/support?action=SEND_SUPPORT_IMAGE" enctype="multipart/form-data" method="post">
                                                         ...
                                                         <i class="bi bi-paperclip fs-3"></i>
																	...
																	<div class="input-group">
																		<div class="custom-file">
																			<input style="display: none;" accept="image/x-png,image/jpeg" name="support_send_image" type="file" class="custom-file-input" id="sp_send_support_image">
																		</div>
																	</div>
																	<input type="hidden" name="support_sup_id" id="support_sup_id" value="">
			...
			<div class="modal fade" id="kt_edit_support_message" tabindex="-1" aria-hidden="true" role="dialog">
				<!--begin::Modal dialog-->
				<div class="modal-dialog modal-dialog-centered mw-650px">
					...
					<div class="modal-content rounded">
						...
						<div class="modal-header pb-0 border-0 justify-content-end">
							<!--begin::Close-->
							<div id="close_support_edit_message" class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
						...
						<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
							...
							<form id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
								...
								<div class="mb-13 text-center">
									<!--begin::Title-->
									<h1 class="mb-3">Edit support message</h1>
									<!--end::Title-->
									<!--begin::Description-->
									<div class="text-muted fw-semibold fs-5">Edit and save support message</div>
									<!--end::Description-->
								</div>
								<!--end::Heading-->
								<!--begin::Input group-->
								<div class="d-flex flex-column mb-8">
									...
									<textarea id="support_edit_message" class="form-control form-control-solid" rows="3" name="target_details" placeholder="Hello user!"></textarea>
								</div>
								<!--end::Input group-->
								<!--begin::Actions-->
								<div class="text-center">
                                 <span onclick="editSupportSave()" id="kt_modal_new_target_submit" class="btn btn-primary">
...
<script>
	...
	function SupportOpenDialog(id, name, email, image, status) {
		...
		$("#support_sup_id").val(id);
		$("#support_info_block").css("display", 'block');
		$("#support_chat_block").load("../api/support?support_user_id=" + id + "&action=GET_PANEL_SUPPORT");
		...
		if(Support_ChatMessage == '') {
			...
			$.ajax({
				...
				success: function(response) {
					...
					if(response == "1") {
						noti("Сообщение успешно отправлено!", "success");
						$("#support_chat_block").load("../api/support?support_user_id=" + support_user_id_hidden + "&action=GET_PANEL_SUPPORT");
						//$("#Support_ChatMessage").val("");
						...
						noti("Сообщение может быть пустым", "error");
					} else if (response === "2") {
						noti("Максимальная длина сообщения - 1000 символов", "error");
					} else if (response === "33") {
						noti("Подождите перед повторной отправкой сообщения", "error");
					} else if (response === "4") {
						noti("Пользовательне не относится к вам", "error");
					} else {
						noti("Произошла неизвестная ошибка, обратитесь в саппорт :(", "error");
					}
				}
				...
				$.ajax({
					...
					success: function(response) {
						...
						if(response == "1") {
							...
							noti("Максимальная длина сообщения - 500 символов", "error");
						} else if (response === "33") {
							noti("Подождите перед повторной отправкой сообщения", "error");
						} else if (response === "4") {
							noti("Пользовательне не относится к вам", "error");
	...
	function SupportDeleteMessageInId(message_id, user_id) {
		$.ajax({
			...
			success: function(response) {
				if(response == "1") {
					noti("Сообщение успешно удалено!", "success");
					$("#support_chat_block").load("../api/support?support_user_id=" + user_id + "&action=GET_PANEL_SUPPORT");
					setTimeout(function() {
						var div = $("#support_chat_block");
						div.scrollTop(div.prop('scrollHeight'));
					}, 100);
					...
					noti("Пользователь не относится к вам");
				} else {
					noti("Произошла неизвестная ошибка, обратитесь в саппорт :(", "error");
				}
			...
			$.ajax({
				...
				success: function(response) {
					if(response == "1") {
						...
						$("#support_chat_block").load("../api/support?support_user_id=" + support_msg_user + "&action=GET_PANEL_SUPPORT");
						setTimeout(function() {
							var div = $("#support_chat_block");
							div.scrollTop(div.prop('scrollHeight'));
						}, 100);
						...
						noti("Сообщение не найдено", "error");
					} else if (response === "7") {
						noti("Вы не изменили текст сообщения", "error");
					} else {
						noti("Произошла неизвестная ошибка, обратитесь в саппорт :(", "error");
					}
				}
				...
				$.ajax({
					...
					success: function(response) {
						if(response == "2") {
							...
							noti("Произошла неизвестная ошибка :(", "error");
						} else {
...
<script>
	setInterval(function() {
		...
		if(hiddenUserId != '') {
			$("#support_chat_block").load("../api/support?support_user_id=" + hiddenUserId + "&action=GET_PANEL_SUPPORT");
		}
	}, 5000)
	...
	setInterval(function() {
		...
		if(refresh_user_id != "") {
			$("#support_chat_block").load("../api/support?support_user_id=" + refresh_user_id + "&action=GET_PANEL_SUPPORT");
			setTimeout(function() {
				var div = $("#support_chat_block");
				div.scrollTop(div.prop('scrollHeight'));
			}, 500);
