...
<head>
	...
	<title>Edit Terms | Partner Panel</title>
	<meta charset="utf-8">
						...
						<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion" kt-hidden-height="242" style="">
									...
									<div class="menu-item">
										<!--begin:Menu link-->
										<a class="menu-link active" href="/panel/edit-aml">
                                    <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                    </span>
					...
					<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
						...
						<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
							...
							<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
								<!--begin::Title-->
								<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Edit Aml-kyc-policy</h1>
								<!--end::Title-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-muted">Edit Aml-kyc-policy</li>
									<!--end::Item-->
								</ul>
								<!--end::Breadcrumb-->
							</div>
						...
						<div id="kt_app_content_container" class="app-container container-fluid">
							<div class="card">
								...
								<div class="card-header">
									<!--begin::Card title-->
									<div class="card-title fs-3 fw-bold">Change the rules</div>
									<!--end::Card title-->
								</div>
								<!--end::Card header-->
								<!--begin::Form-->
								<form id="kt_project_settings_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                                    ...
                                    <span id="first_aml_data" style="display: none;">
										<%
											out.println((String) request.getAttribute("default_aml"));
										%>
                                    </span>
										<textarea cols="47" rows="30" data-height="300" data-provider="summernote" name="post_body" id="amlHtml">
											<%
												out.println(request.getAttribute("worker_aml") == null ? (String) request.getAttribute("default_aml") : (String) request.getAttribute("worker_aml"));
											%>
										</textarea>
										<script>
											$('#amlHtml').summernote({
												placeholder: 'Enter aml..',
												tabsize: 12,
												height: 420,
												toolbar: [
													['style', ['style']],
										...
										<br><br>
										<h5>DOMAIN_NAME - это переменная которую система сама автоматически заменяет на текущий домен на котором открыта страница</h5>
									</div>
									<!--end::Card body-->
									<!--begin::Card footer-->
									<div class="card-footer d-flex justify-content-end py-6 px-9">
										<span id="getAmlHtml" class="btn btn-light btn-active-light-primary me-2">Default Aml</span>
										<span id="saveAmlHtml" class="btn btn-primary gradbuttonsp">Save Aml-kyc-policy</span>
									</div>
									<!--end::Card footer-->
		...
		if(termsHtml == "") {
			...
			$.ajax({
				...
				data: {
					...
					type: "1",
					//костыль
					html: termsHtml.replace(/&/g, "|and|").replace(/=/g, "|equals|").replace(/%3D/g, "|equals|").replace(/%26/g, "|and|")
				},
