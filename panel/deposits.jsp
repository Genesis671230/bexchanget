...
<html lang="en">
	...
	<head><!-- Removed by WebCopy --><!--<base href="">--><!-- Removed by WebCopy -->
        <title>Deposits | Partner Panel</title>
		<meta charset="utf-8">
						...
						<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
							...
							<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div class="menu-item">
										<!--begin:Menu link-->
										<a class="menu-link active" href="/panel/deposits">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
												<span class="svg-icon svg-icon-2">
													<svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<div class="card-body py-3">
											...
											<div class="table-responsive">
												...
												<table class="table table-row-dashed align-middle gs-0 gy-3 table-striped">
													...
													<tbody>
													<%
														List<Map<String, Object>> deposits = (List<Map<String, Object>>) request.getAttribute("deposits");
														for (Map<String, Object> deposit : deposits) {
															Object id = deposit.get("id");
															int statusId = (int) deposit.get("status");
															Object amount = deposit.get("amount");
															Object email = deposit.get("email");
															Object address = deposit.get("address");
															Object date = deposit.get("date");
															out.println("<tr>\n" +
																	"<td>\n" +
																	...
																	"</td>\n" +
																	"<td>" + amount + "$</td>\n" +
																	"<td class=\"text-dark  text-hover-primary fs-6\">" + email + "</td>\n" +
																	"<td class=\"text-dark  fs-6\">" + address + "</td>\n" +
																	"<td class=\"text-dark  fs-6\">" + date + "</td>\n");
															if (statusId == 0) {
																out.println("<td><a onclick=\"paidOut(" + id + ")\" class=\"btn btn-success btn-sm\">Paid out</a></td>\n");
															}
															out.println("</tr>");
														}
													%>
			...
			function paidOut(id) {
				$.ajax({
					...
					success: function(response) {
						if(response == "1") {
							noti("Депозит успешно принят, перезагрузите страницу", "error");
						} else if (response == "2") {
							noti("Депозит уже принят, перезагрузите страницу", "error");
						} else {
							noti("Произошла неизвестная ошибка, перезагрузите страницу", "error");
						}
					}
				})
			}
