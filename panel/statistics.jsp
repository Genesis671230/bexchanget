...
<head>
	...
	<title>Statistics | Partner Panel</title>
	<meta charset="utf-8">
				...
				<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
					...
					<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
						...
						<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link active" href="/panel/statistics">
                                 <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                    <span class="svg-icon svg-icon-2">
                                       <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div id="kt_app_content" class="app-content flex-column-fluid">
						...
						<div id="kt_app_content_container" class="app-container container-fluid">
							<div class="row g-5 g-xl-8">
									...
									<a class="card spmonback hoverable card-xl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body">
                                          ...
                                          <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<!--end::Svg Icon-->
											<%
												out.println("<div class=\"text-white fw-bold fs-2x mb-2 mt-5\"><span class=\"fs-2 me-2\">$</span>" + request.getAttribute("today_profits") + "</div>");
											%>
									...
									<a class="card sptodback hoverable card-xl-stretch mb-xl-8">
										...
										<div class="card-body">
                                          ...
                                          <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<!--end::Svg Icon-->
											<%
												out.println("<div class=\"text-white fw-bold fs-2x mb-2 mt-5\"><span class=\"fs-2 me-2\">$</span>" + request.getAttribute("month_profits") + "</div>");
											%>
									...
									<a class="card spallback hoverable card-xl-stretch mb-xl-8">
										...
										<div class="card-body">
                                          ...
                                          <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<!--end::Svg Icon-->
											<%
												out.println("<div class=\"text-white fw-bold fs-2x mb-2 mt-5\"><span class=\"fs-2 me-2\">$</span>" + request.getAttribute("all_profits") + "</div>");
											%>
									...
									<a class="card spusrback hoverable card-xl-stretch mb-xl-8">
										...
										<div class="card-body">
                                          ...
                                          <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<!--end::Svg Icon-->
											<%
												out.println("<div class=\"text-white fw-bold fs-1 mb-2 mt-5\">" + request.getAttribute("total_users") + " users</div>");
											%>
								...
								<div class="col-xl-6">
									<%
										out.println("<span style=\"display: none;\" id=\"get_all_dep_stat\" data-json=\"" + request.getAttribute("deposits_graphic_data") + "\"></span>");
									%>
									...
									<div class="card card-xl-stretch mb-xl-8">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												...
												<%
													out.println("<span class=\"text-muted fw-semibold fs-6\">" + request.getAttribute("all_profits") + "$</span>");
												%>
											</h3>
										</div>
										<!--end::Header-->
										...
										<div class="card-body">
											<!--begin::Chart-->
											<div id="all_stat" style="height: 250px; position: relative; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
											</div>
											<!--end::Chart-->
										</div>
										<!--end::Body-->
								...
								<div class="col-xl-6">
									<%
										out.println("<span style=\"display: none;\" id=\"get_all_users_stat\" data-json=\"" + request.getAttribute("users_graphic_data") + "\"></span>");
									%>
									<!--begin::Charts Widget 3-->
									<div class="card card-xl-stretch mb-xl-8">
										<!--begin::Header-->
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												...
												<%
													out.println("<span class=\"text-muted fw-semibold fs-6\">" + request.getAttribute("total_users") + " users</span>");
												%>
											</h3>
										</div>
										<!--end::Header-->
										...
										<div class="card-body">
											<!--begin::Chart-->
											<div id="user_stat" style="height: 250px; position: relative; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
											</div>
											<!--end::Chart-->
										</div>
										<!--end::Body-->
												...
												<div class="table-responsive">
													<table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_ecommerce_report_customer_orders_table">
														...
														<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
															<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Customer Name: activate to sort column descending" aria-sort="ascending">
																Partner
															</th>
															<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">
																Amount
															</th>
															<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending">
																Users
															</th>
															<th class="w-160px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Date Joined: activate to sort column ascending">
...
<script>
	...
	function loadStats() {
		var selected_value = $('#statistic_select_category').val();
