...
<head>
	...
	<title>Users | Partner Panel</title>
	<meta charset="utf-8">
								...
								<div class="menu-item px-3">
									<div class="menu-content d-flex align-items-center px-3">
										...
										<div class="d-flex flex-column">
											<%
												String html2 = String.format("<div class=\"fw-bold d-flex align-items-center fs-5\">%s <span class=\"badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2\">%s</span></div>\n" +
				...
				<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
					...
					<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
						...
						<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link active" href="/panel/users">
                                 <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                    <span class="svg-icon svg-icon-2">
                                       <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<div class="card-header border-0 pt-5">
									<div class="card-title">
										...
										<div class="d-flex align-items-center position-relative my-1">
											<form action="/panel/users" method="get" style="display: inline-flex;">
									...
									<div class="card-toolbar">
										<%
											boolean onlineUsers = (boolean) request.getAttribute("online_users");
											if (onlineUsers) {
												out.println("<a href=\"/panel/users?users=offline\" class=\"btn btn-outline btn-outline-dashed btn-outline-danger btn-sm px-4\">" +
														"<span class=\"svg-icon svg-icon-2\">\n" +
														"<svg width=\"20\" height=\"20\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
														"<path d=\"M19.0759 3H4.72777C3.95892 3 3.47768 3.83148 3.86067 4.49814L8.56967 12.6949C9.17923 13.7559 9.5 14.9582 9.5 16.1819V19.5072C9.5 20.2189 10.2223 20.7028 10.8805 20.432L13.8805 19.1977C14.2553 19.0435 14.5 18.6783 14.5 18.273V13.8372C14.5 12.8089 14.8171 11.8056 15.408 10.964L19.8943 4.57465C20.3596 3.912 19.8856 3 19.0759 3Z\" fill=\"currentColor\"></path>\n" +
														"</svg>\n" +
														"</span>Show Offline users</a>");
											} else {
												out.println("<a href=\"/panel/users?users=online\" class=\"btn btn-outline btn-outline-dashed btn-outline-success btn-sm px-4\">\n" +
														"<span class=\"svg-icon svg-icon-2\">\n" +
														"<svg width=\"20\" height=\"20\" viewbox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
														"<path d=\"M19.0759 3H4.72777C3.95892 3 3.47768 3.83148 3.86067 4.49814L8.56967 12.6949C9.17923 13.7559 9.5 14.9582 9.5 16.1819V19.5072C9.5 20.2189 10.2223 20.7028 10.8805 20.432L13.8805 19.1977C14.2553 19.0435 14.5 18.6783 14.5 18.273V13.8372C14.5 12.8089 14.8171 11.8056 15.408 10.964L19.8943 4.57465C20.3596 3.912 19.8856 3 19.0759 3Z\" fill=\"currentColor\"></path>\n" +
														"</svg>\n" +
									...
									<div class="table-responsive">
										...
										<table class="table align-middle gs-0 gy-4 table-row-dashed table-hover">
											...
											<tr class="fw-bold text-muted">
												...
												<th class="min-w-125px">Last activity</th>
											...
											<tbody>
											<%
												List<Map<String, Object>> usersList = (List<Map<String, Object>>) request.getAttribute("users");
												for (Map<String, Object> user : usersList) {
													long id = (long) user.get("id");
													String online = (String) user.get("online");
													String email = (String) user.get("email");
													String domain = (String) user.get("domain");
													String promo = user.get("promo") == null ? "" : (String) user.get("promo");
													String regDate = (String) user.get("reg_date");
													String avatar = (String) user.get("avatar");
													Object lastDate = user.get("last_date");
													Object location = user.get("location");
													Object countryCode = user.get("country_code");
													out.println("<tr>\n" +
															"<td>\n" +
															"<div class=\"d-flex align-items-center\">\n" +
															"<div class=\"symbol symbol-circle symbol-50px overflow-hidden me-3\">\n" +
															"                                                      <span class=\"symbol-label\">\n" +
															"                                                      <a href=\"/panel/user-edit?id=" + id + "\" class=\"text-dark fw-bold text-hover-primary mb-1 fs-6\">\n" +
															"                                                      <img src=\"" + avatar + "\" class=\"w-100\" alt=\"\"> </a>\n" +
															"                                                      </span>\n" +
															"</div>\n" +
															"<div class=\"d-flex justify-content-start flex-column\">\n" +
															"<a href=\"/panel/user-edit?id=" + id + "\" class=\"text-dark fw-bold text-hover-primary mb-1 fs-6\">" + email + "</a>\n" +
															"<span class=\"text-muted fw-semibold text-muted d-block fs-7\">\n" +
															"<span class=\"badge badge-" + (online.equals("Online") ? "success" : "danger") + " badge-circle w-10px h-10px me-1\">\n" +
															"</span> " + online + "\n" +
															"</span>\n" +
															"</div>\n" +
															"</div>\n" +
															"</td>\n" +
															"<td>\n" +
															"<span class=\"badge badge-light fw-bold me-auto px-4 py-3 badge-lg\">" + domain + " / " + promo + "</span>\n" +
															"</td>\n" +
															"<td>\n" +
															"<span class=\"text-dark d-block mb-1 fs-6\">" + regDate + "</span>\n" +
															"</td>\n" +
															"<td>" + (location == null || countryCode == null ? "N/A" : location + ", " + countryCode) + "" +
															(countryCode == null ? "" : "<img src=\"../assets/img/flags/" + ((String) countryCode).toLowerCase() + ".png\" style=\"width: 25px; margin-left: 10px\">") +
															"</td>" +
															"<td>" + lastDate + "</td>" +
															"<td class=\"text-end\">\n" +
															"<a href=\"/panel/support?user=" + id + "\" class=\"btn btn-bg-light btn-color-muted btn-active-color-primary btn-sm px-4\">Support dialog</a>\n" +
															"<a href=\"/panel/user-edit?id=" + id + "\" class=\"btn btn-secondary btn-sm\">View</a>\n" +
															"</td>\n" +
															"</tr>");
												}
											%>
										...
										<%
											...
											int maxPages = (int) request.getAttribute("max_pages");
											String pageHtml = String.format("<p style=\"font-size: 12px; color: #a3a4bd; font-weight: 400;\">You are in page %s of %s</p>\n" +
													"<span style=\"position: absolute; right: 0%%; width: 290px; margin-top: -39px; height: 49px; padding-top: 13px;\">\n" +
													"                                    <a href=\"/panel/users?page=1\" style=\"border: 1px solid #a3a4b6; padding: 5px; color: #a3a4b6; border-radius: 5px; margin-right: 5px;\">FIRST</a>\n" +
													"                                    <a href=\"/panel/users?page=%s\" style=\"border: 1px solid #a3a4b6; padding: 5px; color: #a3a4b6; border-radius: 5px; margin-right: 5px;\">PREVIOUS</a>\n" +
													"                                    <a href=\"/panel/users?page=%s\" style=\"border: 1px solid #a3a4b6; padding: 5px; color: #a3a4b6; border-radius: 5px; margin-right: 5px;\">NEXT</a>\n" +
													"                                    <a href=\"/panel/users?page=%s\" style=\"border: 1px solid #a3a4b6; padding: 5px; color: #a3a4b6; border-radius: 5px; margin-right: 5px;\">LAST</a>",
													currentPage, maxPages, currentPage > 1 ? currentPage - 1 : 1, currentPage >= maxPages ? maxPages : currentPage + 1, maxPages);
