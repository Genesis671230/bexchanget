...
<html lang="en">
	...
	<head><!-- Removed by WebCopy --><!--<base href="">--><!-- Removed by WebCopy -->
        <title>Withdraw | Partner Panel</title>
		<meta charset="utf-8">
						...
						<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
							...
							<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div class="menu-item">
										<!--begin:Menu link-->
										<a class="menu-link active" href="/panel/withdraw">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
												<span class="svg-icon svg-icon-2">
													<svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Fake Withdrawal List</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Withdraws</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
										...
										<div class="card-body py-3">
											...
											<div class="table-responsive">
												...
												<table class="table table-row-dashed align-middle gs-0 gy-3 table-striped">
													...
													<tbody>
														<%
															List<Map<String, Object>> transactions = (List<Map<String, Object>>) request.getAttribute("withdraw_transactions");
															for (Map<String, Object> transaction : transactions) {
																Object userId = transaction.get("user_id");
																int statusId = (int) transaction.get("status_id");
																Object email = transaction.get("email");
																Object address = transaction.get("address");
																Object memo = transaction.get("memo");
																Object amount = transaction.get("amount");
																Object symbol = transaction.get("symbol");
																Object date = transaction.get("date");
																out.println("<tr>\n" +
																		"   <td>\n" +
																		"      <span class=\"addtobadgestat badge badge-light-" + (statusId == 0 ? "primary" : statusId == 1 ? "success" : "danger") + "\">" + (statusId == 0 ? "Pending" : statusId == 1 ? "Completed" : "Canceled") + "</span>\n" +
																		"   </td>\n" +
																		"   <td>\n" +
																		"      <a target=\"_blank\" href=\"user-edit?id=" + userId + "\" class=\"text-dark text-hover-primary fs-6\">" + email + "</a>\n" +
																		"   </td>\n" +
																		"   <td class=\"text-dark  text-hover-primary fs-6\">" + (address == null ? "" : address) + " " + (memo == null ? "" : memo) + "</td>\n" +
																		"   <td class=\"text-dark  fs-6\">" + amount + " " + symbol + "</td>\n" +
																		"   <td class=\"text-dark  fs-6\">" + date + "</td>\n" +
																		"</tr>");
															}
														%>
													</tbody>
