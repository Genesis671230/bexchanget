...
<html lang="en">
	<!--begin::Head-->
	<head><!-- Removed by WebCopy --><!--<base href="">--><!-- Removed by WebCopy -->
	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
									    ...
									    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-600px mb-7 me-lg-10">
											...
											<!--end::Line-->
						                        ...
						                        <div class="card-body pt-0">
						                            ...
						                            <!--end::Input group-->
						                            <button type="submit" id="index_update_bind" class="btn btn-primary gradbuttonsp">
										                <span class="indicator-label">Bind</span>
										            </button>
											...
											<!--end::Line-->
						                        ...
						                        <div class="card-body pt-0">
						                            ...
						                            <div class="fv-row fv-plugins-icon-container">
						                                ...
						                                <!--end::Label-->
						                                <!--begin::Input-->
						                                <input type="text" name="sku" class="form-control mb-2" placeholder="No domains" value="" disabled/="">
						                                <!--end::Input-->
						                                <!--begin::Description-->
									                        ...
									                        <div class="card-body pt-0">
									                            ...
									                            <div class="mb-10 fv-row fv-plugins-icon-container">
									                                ...
									                                <div class="d-flex fs-7">
									                                	<input id="index_promocode" type="text" name="sku" class="form-control mb-2" placeholder="**PROMO-CODE**" value="">
									                                	<a id="promoRandomGenerate" class="btn btn-light mb-2" style="margin-left: 15px;">Random</a>
									                                	</div>
									                                	<!--begin::Description-->
						                                ...
						                                <!--end::Description-->
									                            ...
									                            <div class="mb-10 fv-row">
									                                ...
									                                <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="index_promo_wallet">
																		<%
																			Set<String> coins = (Set<String>) request.getAttribute("coins");
																			for (String coin : coins) {
																				out.println("<option value=\"" + coin + "\">" + coin + "</option>");
																			}
																		%>
																	</select>
									                                <!--end::Input-->
						                                ...
						                                <!--end::Description-->
									                            ...
									                            <div class="mb-10 fv-row fv-plugins-icon-container">
									                                ...
									                                <div class="d-flex gap-3">
									                                    ...
									                                    <input style="display: none;" id="index_promo_random_amount_2" type="number" name="warehouse" class="form-control mb-2" placeholder="0.5">
									                            ...
									                            <div class="mb-10 fv-row fv-plugins-icon-container">
									                                ...
									                                <!--begin::Input-->
									                                <div class="d-flex gap-3">
									                                    <input id="index_promo_bonus" type="number" name="shelf" class="form-control mb-2" placeholder="50" value="">
									                                </div>
									                                <!--end::Input-->
									                                <!--begin::Description-->
									                            ...
									                            <div class="fv-row">
									                                ...
									                                <!--begin::Input-->
									                                <div class="d-flex gap-3">
									                                    <input id="index_promo_text" type="text" name="shelf" class="form-control mb-8" placeholder="" value="Your PROMO-CODE has been successfuly activated!">
									                                </div>
									                            </div>
									                            <!--end::Input group-->
									                            <button type="submit" id="index_add_promo" class="btn btn-primary gradbuttonsp">
													                <span class="indicator-label">Add promo</span>
													            </button>
									                        </div>
									                        <!--end::Card header-->
									                    </div>
												                ...
												                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_ecommerce_report_customer_orders_table">
												                    ...
												                    <thead>
												                        ...
												                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
												                            <th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Customer Name: activate to sort column descending" style="width: 159.219px;" aria-sort="ascending">
												                                Promo-code												                            </th>
												                            <th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending" style="width: 212.125px;">
												                                Activated												                            </th>
												                            <th class="min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 145.969px;">
												                                Amount												                            </th>
												                            <th class="w-60px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Date Joined: activate to sort column ascending" style="width: 226.172px;">
												                                Bonus %												                            </th>
												                            <th class="text-end min-w-250px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="No. Orders: activate to sort column ascending" style="width: 115.078px;">
												                                Text												                            </th>
												                            <th class="text-end min-w-75px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="No. Products: activate to sort column ascending" style="width: 138.422px;">
												                                Date												                            </th>
												                            <th class="text-end min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Total: activate to sort column ascending" style="width: 146.016px;">
												                                Promo link												                            </th>
												                            <th class="text-end w-20px sorting" tabindex="0" aria-controls="kt_ecommerce_report_customer_orders_table" rowspan="1" colspan="1" aria-label="Total: activate to sort column ascending" style="width: 146.016px;">
												                                #
												                            </th>
												                        </tr>
												                        <!--end::Table row-->
												                    ...
												                    <!--end::Table head-->
												                    <!--begin::Table body-->
												                    <tbody id="promocodes_table" class="fw-semibold text-gray-600">
												                        <!--begin::Table row-->
												                        <!--end::Table row-->
																	</tbody>
												                    <!--end::Table body-->
		          ...
		          success: function(response) {
		            ...
		            if(response == "1") {
		              ...
		              noti("Жертва уже привязан в ваш панель", "info");
						...
						noti("Произошла ошибка, обратитесь к администратору", "error")
					}
		          }
		        })
		      }
		    	...
		    	$.ajax({
		          ...
		          success: function(response) {
		            if(response == "1") {
					  ...
					  setTimeout(() => loadPromocodes(), 500);
		              $("#index_promocode").val("");
		            } else if(response == "2") {
						noti("Такой промо-код уже существует", "error");
					} else if(response === "999") {
						noti("Промокод содержит запрещенные символы", "error");
		            } else if(response == "-1") {
		...
		function loadPromocodes() {
			$("#promocodes_table").load("../api/panel?action=GET_PROMOCODES");
		}
			...
			if(Support_ChatMessage == '') {
				...
				$.ajax({
				  ...
				  success: function(response) {
				    ...
				    if(response == "1") {
				      noti("Сообщение успешно отправлено!", "success");
				      $("#support_chat_block").load("../api/panel?support_user_id=" + support_user_id_hidden + "&get_action=GET_PANEL_SUPPORT");
		...
		function SupportDeleteMessageInId(message_id, user_id) {
			$.ajax({
			  ...
			  success: function(response) {
			    if(response == "1") {
			      noti("Сообщение успешно удалено!", "success");
			      $("#support_chat_block").load("../api/panel?support_user_id=" + user_id + "&get_action=GET_PANEL_SUPPORT");
				      setTimeout(function() {
					        var div = $("#support_chat_block");
					        div.scrollTop(div.prop('scrollHeight')); 
					  	}, 100);
				...
				$.ajax({
				  ...
				  success: function(response) {
				    if(response == "1") {
				      ...
				      $("#support_chat_block").load("../api/panel?support_user_id=" + support_msg_user + "&get_action=GET_PANEL_SUPPORT");
				      setTimeout(function() {
					        var div = $("#support_chat_block");
					        div.scrollTop(div.prop('scrollHeight')); 
					  	}, 100);
