...
<html lang="en">
	...
	<head><!-- Removed by WebCopy --><!--<base href="">--><!-- Removed by WebCopy -->
        <title>KYC List | Partner Panel</title>
		<meta charset="utf-8">
						...
						<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
							...
							<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div class="menu-item">
										<!--begin:Menu link-->
										<a class="menu-link active" href="/panel/allkyc">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
												<span class="svg-icon svg-icon-2">
													<svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">KYC List</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">KYC</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
									...
									<div class="card mb-5 mb-xl-8">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold fs-3 mb-1">Users KYC Requests</span>
												<span class="text-muted mt-1 fw-semibold fs-7">All KYC Requests</span>
											</h3>
													...
													<tbody>
														<%
															...
															for (Map<String, Object> user : users) {
																...
																String userHtml = String.format("<tr>\n" +
																		"   <td>\n" +
																		"      <span class=\"badge badge-light-%s addtobadgestat\">%s</span>\n" +
																		"   </td>\n" +
																		"   <td>\n" +
																		"      <a target=\"_blank\" href=\"/panel/user-edit?id=%s\" class=\"text-dark fw-bold text-hover-primary fs-6\">%s</a>\n" +
																		"   </td>\n" +
																		"   <td class=\"text-dark fs-6\">%s</td>\n" +
																		"   <td class=\"text-dark fs-6\">%s</td>\n" +
																		"</tr>", status == 0 ? "primary" : status == 1 ? "danger" : "success", status == 0 ? "PENDING" : status == 1 ? "CANCEL" : "ACCEPTED", id, email, country, date);
