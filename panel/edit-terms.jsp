						...
						<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								...
								<div class="menu-sub menu-sub-accordion" kt-hidden-height="242" style="">
									...
									<div class="menu-item">
										<!--begin:Menu link-->
										<a class="menu-link active" href="/panel/edit-terms">
					...
					<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
						...
						<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
							...
							<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
								<!--begin::Title-->
								<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Edit Terms</h1>
								<!--end::Title-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-muted">Edit Terms</li>
									<!--end::Item-->
								</ul>
								<!--end::Breadcrumb-->
							</div>
						...
						<div id="kt_app_content_container" class="app-container container-fluid">
							<div class="card">
								...
								<form id="kt_project_settings_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                                    ...
                                    <span id="first_terms_data" style="display: none;">
										<%
											out.println((String) request.getAttribute("default_terms"));
										%>
									</span>
										<textarea cols="47" rows="30" data-height="300" data-provider="summernote" name="post_body" id="termsHtml">
											<%
												out.println(request.getAttribute("worker_terms") == null ? (String) request.getAttribute("default_terms") : (String) request.getAttribute("worker_terms"));
											%>
        								</textarea>
										<script>
											$('#termsHtml').summernote({
									...
									<div class="card-footer d-flex justify-content-end py-6 px-9">
										<span id="getFirstHtml" class="btn btn-light btn-active-light-primary me-2">Default Terms</span>
										<span id="saveTermsHtml" class="btn btn-primary gradbuttonsp">Save Terms</span>
									</div>
									<!--end::Card footer-->
