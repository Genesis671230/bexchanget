...
<div class="vh-100 d-flex justify-content-center">
    <div class="form-access my-auto">
        <form action="#">
            <span>2FA Login</span>
            <h6 style="font-size: 12px; text-align: center; display: block; margin-bottom: 17px; color: #7293b7;">Please enter the code generated<br> by your Google Authenticator app</h6>
            <div class="form-group">
                <input style="background: #171717;" id="login_2fa" type="number" class="form-control login-input" placeholder="Enter 2FA code..">
            </div>
            <button id="sign_in" type="submit" class="btn btn-primary">Sign In</button>
        </form>
    </div>
</div>
...
<script>
    $("#sign_in").on("click", function(e) {
        ...
        var login_2fa = $("#login_2fa").val();

        if(login_2fa == '') {
            noti("Please enter a valid 2FA code", 'warning');
        } else {
            $.ajax({
                url: "/sign",
                type: "POST",
                ...
                success: function(response) {
                    ...
                    if(response == "1") {
                        ...
                        noti("Enter the correct 2FA code", "error");
                    } else {
