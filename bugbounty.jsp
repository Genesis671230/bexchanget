...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <%
        out.println("<title>Bug Bounty Program | " + request.getAttribute("domain_exchange_name") + "</title>");
    %>
  <%
...
<li>●&nbsp;&nbsp;&nbsp; Sensitive information retained as plaintext in the device&rsquo;s memory</li>
...
<ul>
<li>
<p>●&nbsp;&nbsp;&nbsp; immediately submit a report to mail@tochka.com</p>
</li>
<li>
...
<li>
<p>●&nbsp;&nbsp;&nbsp; NOT cause any damage to <% out.println(request.getAttribute("domain_exchange_name")); %> infrastructure and its users</p>
</li>
<li>
<p>●&nbsp;&nbsp;&nbsp; NOT mislead users or employees of <% out.println(request.getAttribute("domain_exchange_name")); %> while detecting vulnerabilities</p>
</li>
</ul>
<ol start="2">
<li>
...
<li>
<p>●&nbsp;&nbsp;&nbsp; Do not use the detected vulnerabilities for unjust enrichment. If you use the vulnerability in such a way that can cause harm to <% out.println(request.getAttribute("domain_exchange_name")); %>, our users and third parties and do not report to <% out.println(request.getAttribute("domain_exchange_name")); %> about the vulnerability, you will not receive a reward and we reserve the right to commence legal action against you.</p>
</li>
<li>
...
<p>You may let us know about non-security issues at mail@tochka.com</p>
