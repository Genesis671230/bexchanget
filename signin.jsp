...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <%
        out.println("<title>Sign in | " + request.getAttribute("domain_exchange_name") + "</title>");
    %>
  <%
      ...
      <div class="form__left">
        ...
        <form class="form__box" action="#">
          <div class="form__group">
            ...
            <input class="form__input" type="email" placeholder="Enter your email" id="login_email">
          </div>

          <div class="form__group">
            <label class="form__name form__name-password" for="form-password">Password</label>
            <input class="form__input" type="password" placeholder="Enter your password" id="login_password">
          </div>

          <div class="form__features">
            <div class="form__features-wrapper">
              <label class="form__features-label" for="form-remember">Remember me
                <input class="form__features-checkbox" type="checkbox" id="form-remember">
                <span class="form__features-checkmark"></span>
              </label>
            </div>

            <a class="form__features-forget" href="reset-password">Forgot password?</a>
          </div>

          <button class="form__button" type="submit" id="sign_in">
            <span>Sign In</span>
          </button>
        </form>

        <div class="form__sub">
          <div class="form__sub-text">New user?</div>
          <a class="form__sub-link" href="/signup">Sign up</a>
        </div>
      </div>

      <div class="form__right">
        <img src="/assets/img/space_one.jpg" alt="">
      </div>
    </div>
  </section>
...
<script>
  ...
  $("#sign_in").on("click", function(e) {
    ...
    if(login_email == '' || login_email.length < 10 || login_email.length > 128) {
      noti("Please enter a valid email address", 'warning');
    } else if(login_password == '' || login_password.length < 6) {
      noti("Please enter your password", 'warning');nu
    } else {
      ...
      $.ajax({
          ...
          success: function(response) {
            ...
            if(response == "1") {
              ...
              disabledBtn("on");
            } else if(response == "replace_2fa") {
              location.replace("signin-2fa");
            } else if(response == "replace_2fa_error") {
