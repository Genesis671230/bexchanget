...
<head>
    ...
    <%
        out.println("<title>Deposit coins | " + request.getAttribute("domain_exchange_name") + "</title>");
    %>
    <%
        ...
        <div class="header__profile">
            ...
            <div class="header__profile-box">
                ...
                <div class="header__profile-center">
                    ...
                    <div class="header__profile-tools-box"><a class="header__profile-link header__profile-tools" href="#">
                    ...
                    <div class="menuProfile__container">
                        <div class="menuProfile__box">
                            <div class="menuProfile__menu-box">
                                ...
                                <a class="menuProfile__menu-item mdi mdi-database active" href="/profile/deposit">Deposit</a>
                            ...
                            <div class="deposit__coin-list-box">
                                <div class="deposit__coin-list-wrapper">
                                    ...
                                    <div id="btnBox" class="deposit__coin-list">
                                        <%
                                            List<Map<String, Object>> depositCoins = (List<Map<String, Object>>) request.getAttribute("deposit_coins");
                                            boolean first2 = true;
                                            for (Map<String, Object> coin : depositCoins) {
                                                String symbol = (String) coin.get("symbol");
                                                String name = (String) coin.get("name");
                                                String tab = name.replace(" ", "_");
                                                String image = (String) coin.get("image");
                                                String balance = (String) coin.get("balance");

                                                String coinHtml = "<div onclick=\"setTab('" + tab + "')\" id=\"btn_" + tab + "\" class=\"rushButton deposit__coin-item" + (first2 ?  " buttonActiveNew" : "") + "\">\n" +
                                                        "<img class=\"deposit__coin-img\" src=\"" + image + "\" alt=\"\">\n" +
                                                        "<div class=\"deposit__coin-title\">" + name + "</div>\n" +
                                                        "<div class=\"deposit__coin-wallet\">" + balance + " " +  symbol + "</div>\n" +
                                                        "</div>";

                                                out.println(coinHtml);
                            ...
                            <div class="deposit__content-list">
                                <%
                                    ...
                                    for (Map<String, Object> coin : depositCoins) {
                                        ...
                                        String image = (String) coin.get("image");
                                        String balance = (String) coin.get("balance");
                                        String address = (String) coin.get("address");
                                        String memo = (String) coin.get("memo");
                                        String minDepositAmount = (String) coin.get("min_deposit_amount");

                                        out.println("<div id=\"tab_" + tab + "\" class=\"deposit__content-item" + (first ? " deposit__content-item-active" : "") + "\">\n" +
                                                "<div class=\"deposit__content-title\">Wallet Deposit Address</div>\n" +
                                                "<div class=\"deposit__crypto-box\">\n" +
                                                "   <img class=\"deposit__crypto-logo\" src=\"" + image + "\" alt=\"\">\n" +
                                                "   <div class=\"deposit__crypto-info\">\n" +
                                                "      <div class=\"deposit__crypto-box-title\">" + symbol + " " + name + "</div>\n" +
                                                "      <div class=\"deposit__crypto-box-wallet\">" + balance + "</div>\n" +
                                                "   </div>\n" +
                                                "</div>\n" +
                                                "<div class=\"deposit__center-content\">\n" +
                                                "   <img class=\"deposit__qr-code\" src=\"https://chart.googleapis.com/chart?chs=250x250&amp;cht=qr&amp;chl=" + address + "\" alt=\"\">\n" +
                                                "   <div class=\"deposit__text-items\">\n" +
                                                "      <div class=\"deposit__text-item\">\n" +
                                                "         Coins will be deposited after 3 network confirmations.\n" +
                                                "      </div>\n" +
                                                "      <div class=\"deposit__text-item\">\n" +
                                                "         Send only " + symbol + " to this deposit address. Sending coin or token other than " + symbol + " to this address may result in the loss of your deposit.\n" +
                                                "      </div>\n" +
                                                "      <div class=\"deposit__text-item\">\n" +
                                        ...
                                        if (memo != null) {
                                            out.println("<div class=\"deposit__address__box isset_memo__add_bottom\">\n" +
                                                    "   <label style=\"width: 100%;\">\n" +
                                                    "   <input id=\"address_" + tab + "\" class=\"deposit__address\" type=\"text\" value=\"" + address + "\" readonly=\"\">\n" +
                                                    "   <button class=\"deposit__address-btn\" onclick=\"copyThisAddress('" + tab + "')\">COPY</button>\n" +
                                                    "   </label>\n" +
                                                    "   <label style=\"width: 100%; margin-bottom: -60px;\">\n" +
                                                    "      <input class=\"deposit__address\" type=\"text\" value=\"" + memo + "\" readonly=\"\">\n" +
                                            ...
                                            out.println("<div class=\"deposit__address__box \">\n" +
                                                    "   <label style=\"width: 100%;\">\n" +
                                                    "   <input id=\"address_" + tab + "\" class=\"deposit__address\" type=\"text\" value=\"" + address + "\" readonly=\"\">\n" +
                                                    "   <button class=\"deposit__address-btn\" onclick=\"copyThisAddress('" + tab + "')\">COPY</button>\n" +
                                                    "   </label>\n" +
...
<script>
    ...
    let firstCrypto = document.getElementsByClassName('deposit__content-item deposit__content-item-active')[0];
    var active_crypto = firstCrypto.id.split("_")[1];
