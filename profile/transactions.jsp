...
<head>
    ...
    <%
        out.println("<title>Transactions history | " + request.getAttribute("domain_exchange_name") + "</title>");
    %>
    <%
                        ...
                        <div class="menuProfile__box">
                            <div class="menuProfile__menu-box">
                                ...
                                <div class="menuProfile__more">
                                    <a class="menuProfile__menu-item menuProfile__item-mobile mdi mdi-history active" href="/profile/transactions">Transactions</a>
                                            ...
                                            <%
                                                ...
                                                if (!transactions.isEmpty()) {
                                                    for (Map<String, Object> transaction : transactions) {
                                                        ...
                                                        Object time = transaction.get("time");
                                                        ...
                                                        int status = (int) transaction.get("status");
                                                        Object hash = transaction.get("hash");
                                                        ...
                                                        out.println("<tr>\n" +
                                                                ...
                                                                "<td><span class=\"status_" + (status == 0 ? "pending" : status == 1 ? "completed" : "canceled") + "\">" + (status == 0 ? "Pending" : status == 1 ? "Completed" : "Canceled") + "</span></td>\n" +
                                                                "<td>" + hash + "</td>\n" +
                                                                "</tr>");
                                                    }
                                                } else {
