...
<head>
	...
	<%
		out.println("<title>AML & KYC Policy | " + request.getAttribute("domain_exchange_name") + "</title>");
	%>
	<%
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-header-info">
							<h4 class="card-title-info">AML & KYC policy</h4>
						</div>
						<div class="card-body">
							<div class="row justify-content-center">
								<div class="textinfo">
									<%
										out.println(request.getAttribute("aml"));
									%>
								</div>
							</div>
						</div>
